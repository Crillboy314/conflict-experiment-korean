    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', otree.db.models.StringField(max_length=10000, null=True, verbose_name='What is your native language?')),
                ('country', otree.db.models.StringField(max_length=10000, null=True, verbose_name='In which country were you born?')),
